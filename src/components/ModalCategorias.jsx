...
export function ModalCategorias({ onClose, getCategorias, categorias, getProdutos }) {
        ...
        <div className={styles.overlay}>
            <div className={styles.modal}>
                ...
                <div className={styles.formRow}>
                    ...
                    <button type="button" onClick={handleCreateCategoria}>
                        ...
                        categorias.map((item) => (
                            ...
                            <div className={styles.formRow} key={item.id}>
                                ...
                                {categoriaEditId == item.id ? (
                                    <button type='button' onClick={() => handleEditCategoria(item.id)}>
                                            Salvar
                                    </button>
                                ) : (
                                    <button type='button' onClick={() => handleActionEditCategoria(item.id, item.nome)}>
                                        <PencilLine size={16} /> Editar
                                    </button>
                                )}

                                <button type='button' onClick={()=>handleDeleteCategoria(item.id)}>
